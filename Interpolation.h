...
private:
    static void fillArc(Matrix& matrixX, Matrix& matrixY, int i1, int i3, int j1, int j3, Point p1, Point p2, Point p3);
    ...
    static double fInterp(Point a, Point b, Point c, Point d,
                          double fA, double fB, double fC, double fD);
};
